...
void Keyboard::Init(QString style, int fontSize) {
...
void Keyboard::changeStyle(QString topColor, QString bottomColor, QString borderColor, QString textColor)
{
    QStringList qss;
