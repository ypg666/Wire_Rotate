// LineRotate2.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
thresholdValue2 LineRotate2::thresholdValue2_struct;
/*
int main()
{
...
int LineRotate2::read()
{
    return thresholdValue2_struct.yellow_h_min;
}

void LineRotate2::init(std::vector<std::vector<int>> params) {
    assert(params.size() == 4 && params[0].size() == 10);
    thresholdValue2_struct.blue_h_min = params[0][0];
    thresholdValue2_struct.blue_h_max = params[0][1];
    thresholdValue2_struct.blue_s_min = params[0][2];
    thresholdValue2_struct.blue_s_max = params[0][3];
    thresholdValue2_struct.blue_v_min = params[0][4];
    thresholdValue2_struct.blue_v_max = params[0][5];
    thresholdValue2_struct.blue_cr_min = params[0][6];
    thresholdValue2_struct.blue_cr_max = params[0][7];
    thresholdValue2_struct.blue_cb_min = params[0][8];
    thresholdValue2_struct.blue_cb_max = params[0][9];

    thresholdValue2_struct.green_h_min = params[1][0];
    thresholdValue2_struct.green_h_max = params[1][1];
    thresholdValue2_struct.green_s_min = params[1][2];
    thresholdValue2_struct.green_s_max = params[1][3];
    thresholdValue2_struct.green_v_min = params[1][4];
    thresholdValue2_struct.green_v_max = params[1][5];
    thresholdValue2_struct.green_cr_min = params[1][6];
    thresholdValue2_struct.green_cr_max = params[1][7];
    thresholdValue2_struct.green_cb_min = params[1][8];
    thresholdValue2_struct.green_cb_max = params[1][9];

    thresholdValue2_struct.yellow_h_min = params[2][0];
    thresholdValue2_struct.yellow_h_max = params[2][1];
    thresholdValue2_struct.yellow_s_min = params[2][2];
    thresholdValue2_struct.yellow_s_max = params[2][3];
    thresholdValue2_struct.yellow_v_min = params[2][4];
    thresholdValue2_struct.yellow_v_max = params[2][5];
    thresholdValue2_struct.yellow_cr_min = params[2][6];
    thresholdValue2_struct.yellow_cr_max = params[2][7];
    thresholdValue2_struct.yellow_cb_min = params[2][8];
    thresholdValue2_struct.yellow_cb_max = params[2][9];

    thresholdValue2_struct.brown_h_min = params[3][0];
    thresholdValue2_struct.brown_h_max = params[3][1];
    thresholdValue2_struct.brown_s_min = params[3][2];
    thresholdValue2_struct.brown_s_max = params[3][3];
    thresholdValue2_struct.brown_v_min = params[3][4];
    thresholdValue2_struct.brown_v_max = params[3][5];
    thresholdValue2_struct.brown_cr_min = params[3][6];
    thresholdValue2_struct.brown_cr_max = params[3][7];
    thresholdValue2_struct.brown_cb_min = params[3][8];
    thresholdValue2_struct.brown_cb_max = params[3][9];
}

void LineRotate2::init(std::vector<int> params, int flag) {
    assert(params.size() == 10);
    if(flag == 1){
        thresholdValue2_struct.blue_h_min = params[0];
        thresholdValue2_struct.blue_h_max = params[1];
        thresholdValue2_struct.blue_s_min = params[2];
        thresholdValue2_struct.blue_s_max = params[3];
        thresholdValue2_struct.blue_v_min = params[4];
        thresholdValue2_struct.blue_v_max = params[5];
        thresholdValue2_struct.blue_cr_min = params[6];
        thresholdValue2_struct.blue_cr_max = params[7];
        thresholdValue2_struct.blue_cb_min = params[8];
        thresholdValue2_struct.blue_cb_max = params[9];
    }
    else if(flag == 2){
        thresholdValue2_struct.green_h_min = params[0];
        thresholdValue2_struct.green_h_max = params[1];
        thresholdValue2_struct.green_s_min = params[2];
        thresholdValue2_struct.green_s_max = params[3];
        thresholdValue2_struct.green_v_min = params[4];
        thresholdValue2_struct.green_v_max = params[5];
        thresholdValue2_struct.green_cr_min = params[6];
        thresholdValue2_struct.green_cr_max = params[7];
        thresholdValue2_struct.green_cb_min = params[8];
        thresholdValue2_struct.green_cb_max = params[9];
    }
    else if(flag == 3){
        thresholdValue2_struct.yellow_h_min = params[0];
        thresholdValue2_struct.yellow_h_max = params[1];
        thresholdValue2_struct.yellow_s_min = params[2];
        thresholdValue2_struct.yellow_s_max = params[3];
        thresholdValue2_struct.yellow_v_min = params[4];
        thresholdValue2_struct.yellow_v_max = params[5];
        thresholdValue2_struct.yellow_cr_min = params[6];
        thresholdValue2_struct.yellow_cr_max = params[7];
        thresholdValue2_struct.yellow_cb_min = params[8];
       thresholdValue2_struct.yellow_cb_max = params[9];
}
    else if(flag == 4){
        thresholdValue2_struct.brown_h_min = params[0];
        thresholdValue2_struct.brown_h_max = params[1];
        thresholdValue2_struct.brown_s_min = params[2];
        thresholdValue2_struct.brown_s_max = params[3];
        thresholdValue2_struct.brown_v_min = params[4];
        thresholdValue2_struct.brown_v_max = params[5];
        thresholdValue2_struct.brown_cr_min = params[6];
        thresholdValue2_struct.brown_cr_max = params[7];
        thresholdValue2_struct.brown_cb_min = params[8];
        thresholdValue2_struct.brown_cb_max = params[9];
    }

}


int LineRotate2::getRotate(cv::Mat srcImage)
{
    try {
...
//debug模式的重载
int LineRotate2::getRotate(cv::Mat srcImage, bool debug, std::string debugFilePath)
{
...
void LineRotate2::getColorMask(cv::Mat & image)
...
//        std::cout << "got ROI Block" << std::endl;
    ...
    //提取蓝色区域
    cv::threshold(temp_HSV[0], blueMask1, thresholdValue2_struct.blue_h_min, 255, cv::THRESH_BINARY);
    cv::threshold(temp_HSV[0], blueMask2, thresholdValue2_struct.blue_h_max, 255, cv::THRESH_BINARY_INV);
    cv::threshold(temp_HSV[1], blueMask3, thresholdValue2_struct.blue_s_min, 255, cv::THRESH_BINARY);
    cv::threshold(temp_HSV[2], blueMask4, thresholdValue2_struct.blue_v_min, 255, cv::THRESH_BINARY);
    ...
    //提取绿色区域
    cv::threshold(temp_HSV[0], greenMask1, thresholdValue2_struct.green_h_min, 255, cv::THRESH_BINARY);
    cv::threshold(temp_HSV[0], greenMask2, thresholdValue2_struct.green_h_max, 255, cv::THRESH_BINARY_INV);
    cv::threshold(temp_HSV[1], greenMask3, thresholdValue2_struct.green_s_min, 255, cv::THRESH_BINARY);
    cv::threshold(temp_HSV[2], greenMask4, thresholdValue2_struct.green_v_min,255, cv::THRESH_BINARY);
    ...
    //提取黄棕色区域
    cv::threshold(temp_HSV[0], ybMask1, thresholdValue2_struct.yellow_h_min, 255, cv::THRESH_BINARY);
    cv::threshold(temp_HSV[0], ybMask2, thresholdValue2_struct.yellow_h_max, 255, cv::THRESH_BINARY_INV);
    cv::threshold(temp_HSV[2], ybMask3, thresholdValue2_struct.yellow_v_min, 255, cv::THRESH_BINARY);
    cv::bitwise_or(ybMask1, ybMask2, ybMask);
    cv::bitwise_and(ybMask, ybMask3, ybMask);
    //提取黄色区域
    cv::threshold(temp_YCrCb[2], yellowMask1, thresholdValue2_struct.yellow_cb_max, 255, cv::THRESH_BINARY_INV);
    cv::bitwise_and(ybMask, yellowMask1, yellowMask);
    //提取棕色区域
    cv::threshold(temp_YCrCb[2], brownMask1, thresholdValue2_struct.brown_cb_min, 255, cv::THRESH_BINARY);
    ...
    //寻找最大的连通域
    findBlockMaxContour(yellowgreenMask, YELLOWGREENMASK2);
    findBlockMaxContour(brownMask, BROWNMASK2);
    findBlockMaxContour(blueMask, BLUEMASK2);

}

void LineRotate2::getBlockInfo()
{
    cv::Moments temp;
    //计算各个区块的位置的和大小
    //蓝色区域
...
void LineRotate2::findBlockMaxContour(cv::Mat maskImage, SELECT2 block)
//寻找每个区块的最大连通域
{
...
void LineRotate2::getRoIImage(cv::Mat & image, cv::Mat & result)
// 找到线头获取RoI区域
{
    cv::Mat temp;
