...
#include "ui_adjustParameters2.h"

AdjustParameters2::AdjustParameters2(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AdjustParameters2)
{
    ui->setupUi(this);
...
AdjustParameters2::~AdjustParameters2()
{
    delete ui;
}

void AdjustParameters2::setWinTitle(QString titleStr)
{
    this->winTitle = titleStr;
    this->setWindowTitle(this->winTitle);
}

void AdjustParameters2::setParamMin(std::vector<int> params)
{
    paramMin = params;
...
void AdjustParameters2::setParamMax(std::vector<int> params)
{
    paramMax = params;
...
void AdjustParameters2::setParamDefault(std::vector<int> params)
{
    paramDefault = params;
...
void AdjustParameters2::setInDisplay(cv::Mat inputImg)
{
...
void AdjustParameters2::on_saveParams_clicked()
{
    int flag = 0;
    //qDebug() << winTitle << endl;
    if(winTitle == QString::fromLocal8Bit("蓝色通道参数调整")){
        ParamSetting2 paramSet;
        QString str;
        str.sprintf("Blue");
...
void AdjustParameters2::on_resetParams_clicked()
{
    //qDebug() << winTitle << endl;
    if(winTitle == QString::fromLocal8Bit("蓝色通道参数调整")){
...
void AdjustParameters2::updateParamValue()
{
...
QImage AdjustParameters2::cvMat2QImage(cv::Mat mat)
{
